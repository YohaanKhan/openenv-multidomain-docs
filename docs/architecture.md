...
```text
openenv_multidomain/
├── benchmarks/           # Evaluation metrics and baseline tracking
├── docs/                 # Documentation (this website's source)
├── domains/              # Plugin domains
│   ├── hr/               # HR domain logic and schemas
│   ├── legal/            # Legal domain
│   └── saas/             # SaaS domain (core benchmark showcase)
├── scripts/              # Training and utility scripts
├── server/               # Core engine agnostic of domains
│   ├── app.py            # FastAPI entrypoint
│   ├── environment.py    # Core state and trajectory tracking
│   ├── domain_registry.py# Plugin loader
│   └── interfaces.py     # Base contracts (BaseDomain, BaseGrader)
